...
* __高速道路 車線変更用ショート ウィンカー<sup>new! v1.7</sup>__
...
* __給油を開始すると、ボタンを離しても満タンまで給油し続ける<sup>new! v1.5.1</sup>__
...
#### 高速道路 車線変更用ショート ウィンカー<sup>new! v1.7</sup>
* 高速道路等で、車線変更用にウィンカーを出したら数秒で自動的に消える機能です。
* 一部の実車では、レバーを軽く押す、という操作なのですが、実現できないため、下記３つの条件指定で動作します。
  * 有効になる最低速度
  * 無効になるハンドル回転角度
...
### その他 アクション設定
#### 給油を開始すると、ボタンを離しても満タンまで給油し続ける<sup>new! v1.5.1</sup>
